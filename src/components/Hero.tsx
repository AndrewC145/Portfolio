...
function Hero() {
  return (
    <div className="px-4 pb-12 sm:px-6 sm:pb-16 md:pb-20 lg:pb-30 xl:pb-36 2xl:pb-40">
      <div className="relative top-0 right-0 left-0 h-[90vh] w-full overflow-hidden rounded-3xl">
